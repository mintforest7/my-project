...
const fitPresets: Record<Category, Record<string, FitPreset>> = {
  ...
  dresses: {
    ...
    'dress-30': dressSlot(4.05, -1.61),
    'dress-31': dressSlot(2.39, -1.61),
    'dress-32': dressSlot(1.43, -2.26),
    'dress-33': dressSlot(1.19, -2.42),
    'dress-34': dressSlot(0.96, -0.97),
    'dress-35': dressSlot(3.33, -1.94, 0.93),
    'dress-36': dressSlot(1.67, -0.64, 1.04),
    'dress-37': dressSlot(1.19, -1.61),
    'dress-38': dressSlot(1.19, -1.61),
    'dress-39': dressSlot(0.95, 0, 1.14),
    'dress-40': dressSlot(2.61, -1.13, 0.95),
  },
  shoes: {},
  bags: {
